...
insert into public.services (id, name, description, long_description, category, price, duration_minutes, active, sort_order) values
  ...
  ($shx$svc-seat-clean$shx$, $shx$Seat Cleaning$shx$, $shx$Cleaning of vehicle seats using methods appropriate for the seat material.$shx$, $shx$Seats accumulate dirt, oils, and stains from regular use. Our Seat Cleaning service adapts to your seat material — fabric seats receive deep extraction cleaning while leather seats are cleaned and conditioned. We address visible stains and restore a fresh, clean appearance.$shx$, $shx$Interior Cleaning$shx$, 500, 25, true, 11),
...
A full detail is more than a wash — it is a comprehensive cleaning and restoration service designed to bring your vehicle closer to its best condition.$shx$, $shx$Shinex Team$shx$, $shx$Detailing$shx$, $shx$4 min read$shx$, $shx$2026-09-21T08:00:00.000Z$shx$) on conflict (id) do nothing;
...
Every vehicle that comes through our bay receives the same level of attention and care, whether it is a quick exterior wash or a full showroom-detail package. We use quality products, proven techniques, and a team that takes pride in every job.$shx$,
  $shx$To provide convenient, professional, and reliable car wash and detailing services that keep Nairobi's vehicles looking their best — without the stress of long waits or uncertain quality.
...
We are committed to making car care simple: easy online booking, transparent pricing, honest communication, and a team that genuinely cares about the results.$shx$,
  $shx$[{"title":"Quality Workmanship","description":"Every vehicle receives careful, thorough attention. We do not cut corners — we take pride in delivering results that meet professional standards."},{"title":"Honest Pricing","description":"What you see on our website is what you pay. No hidden fees, no surprise charges, no pressure upsells at the counter."},{"title":"Convenience","description":"Online booking, flexible appointment times, and efficient service so you can get your car cleaned without disrupting your day."},{"title":"Customer Care","description":"We treat every vehicle like it is our own and every customer like a neighbour. Your satisfaction is not just a goal — it is the standard we hold ourselves to."}]$shx$::jsonb,
  $shx$["Simple online booking — choose your service and schedule in under a minute","Professional cleaning using quality products and proven techniques","Experienced, trained staff who take pride in their work","Flexible appointment times that work around your schedule","Transparent pricing with no hidden costs","A full range of services from quick washes to complete detailing"]$shx$::jsonb
