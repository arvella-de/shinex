...
export default function Footer() {
  return (
    <footer className="bg-ink text-cream">
      <div className="container-shx grid gap-10 py-14 md:grid-cols-[1.3fr_1fr_1fr]">
        <div>
          <Logo dark />
          <p className="mt-4 max-w-xs font-body text-sm leading-relaxed text-cream/60">
            Nairobi&apos;s no-fuss car wash booking service. Pick a slot,
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 font-body text-sm text-cream/60">
            ...
            <li>Mon&ndash;Sun, 7:00&ndash;19:00</li>
          </ul>
        </div>
      </div>
